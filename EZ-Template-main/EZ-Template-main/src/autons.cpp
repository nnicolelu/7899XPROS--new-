...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(3.8, 0.0, 3.0);         // 3.0, 0.0, 3.0
  chassis.pid_heading_constants_set(1.0, 0.0, 0.5);        // Holds the robot straight while going forward without odom 1 0 0.5
...
void left4Ball() {
  ...
  topRollers.move(127);
  topIntake.move(127);
  chassis.pid_drive_set(22_in, 90, true); // match loading
  pros::delay(1250);
...
void skills() {
  ...
  topRollers.move(0);
  topIntake.move(0);
  chassis.pid_drive_set(-36_in, DRIVE_SPEED, true); // 32
  pros::delay(690);
  chassis.pid_turn_set(90_deg, TURN_SPEED);
  pros::delay(430);
  bottomRollers.move(127);
  chassis.pid_drive_set(19.5_in, DRIVE_SPEED, true); // blue block 20.5
  pros::delay(680);
  chassis.pid_turn_set(40_deg, TURN_SPEED); // 38
  pros::delay(380);
  chassis.pid_drive_set(-18_in, 70, true); // middle go
  stopPiston.set(true);
  pros::delay(400);
  ...
  simpleMoveFront(21); // checking distance for match laoder
  pros::delay(1000);
  chassis.pid_turn_set(0_deg, TURN_SPEED);
  pros::delay(420);
  matchLoader.set(true);
  topIntake.move(127);
  pros::delay(100);
  chassis.pid_drive_set(18_in, 65, true); // getting first match loader
  pros::delay(3000); //2100
  ...
  pros::delay(200);
  simpleMoveFront(3); // checking distance before turning to 2nd quadrant
  pros::delay(560);
  ...
  chassis.pid_turn_set(250_deg, TURN_SPEED);
  pros::delay(450);
  chassis.pid_drive_set(20.5_in, DRIVE_SPEED, true); // 23
  pros::delay(300);
  chassis.pid_turn_set(-180_deg, TURN_SPEED);  // -180
  pros::delay(380);
  stopPiston.set(true);
  chassis.pid_drive_set(-19_in, 100, true); // scoring first match loader
  pros::delay(590);
  topIntake.move(127);
  bottomRollers.move(127);
  topRollers.move(127);
  pros::delay(2000); // 1400
  stopPiston.set(false);
  matchLoader.set(true);
  chassis.pid_turn_set(180_deg, TURN_SPEED);
  pros::delay(300);
  chassis.pid_drive_set(36_in, 80, true); // second match loader
  pros::delay(3000); //2500
  topIntake.move(0);
  topRollers.move(0);
  //stopPiston.set(true);
  chassis.pid_turn_set(180_deg, TURN_SPEED);
  pros::delay(200);
  chassis.pid_drive_set(-33_in, 70, true); // scoring second match loader
  pros::delay(750);
  stopPiston.set(true);
  topIntake.move(127);
  topRollers.move(127);
  ...
  stopPiston.set(false);
  matchLoader.set(true);
  chassis.pid_drive_set(34_in, 60, true); // getting 3rd match loader
  pros::delay(3000); //1000
  stopPiston.set(false);
  bottomRollers.move(127);
  topRollers.move(127);
  topIntake.move(127);
  ...
  chassis.pid_turn_set(0_deg, TURN_SPEED);
  pros::delay(500);
  chassis.pid_drive_set(-20_in, 80, true); // scoring 3rd match loader
  pros::delay(500);
  stopPiston.set(true);
  topRollers.move(127);
  topIntake.move(127);
  ...
  pros::delay(300); 
  chassis.pid_drive_set(28_in, DRIVE_SPEED, true); // 29
  pros::delay(700);
...
void soloAWP()  {
  ...
  matchLoader.set(true);
  pros::delay(200); 
  chassis.pid_drive_set(14.5_in, DRIVE_SPEED, true); //12_in
  pros::delay(900);
  ...
  chassis.pid_drive_set(56_in, 80, true); //48_in=
