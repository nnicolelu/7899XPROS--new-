...
void leftHold() {
  ...
  chassis.pid_turn_set(-180_deg, TURN_SPEED);
  pros::delay(300);
  chassis.pid_drive_set(-40_in, 90, true); // scoring
  pros::delay(800);
  stopPiston.set(true);
  matchLoader.set(false);
  bottomRollers.move(127);
...
void skills() {
  ...
  pros::delay(1000);
  chassis.pid_drive_set(-28_in, 60, true);
  pros::delay(1400);
  topIntake.move(0);
  ...
  pros::delay(500);
  bottomRollers.move(127);
  chassis.pid_drive_set(24_in, DRIVE_SPEED, true); // blue block
  pros::delay(700);
  ...
  pros::delay(300);
 // /*
  chassis.pid_turn_set(43_deg, TURN_SPEED); // done with middle goal
  pros::delay(380);
  ...
  topRollers.move(127);
  topIntake.move(127);
  chassis.pid_drive_set(22_in, 50, true); // getting first match loader
  pros::delay(2100);
